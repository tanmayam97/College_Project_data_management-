...
<body>
  ...
  <main>
    <h2 class="page-heading">Students</h2>
...
while($row = $result->fetch_assoc()) {
  ?>
   <form method="post" action="studentlist.php">
    <input type="hidden" name="tid" value="<?php echo $_SESSION['id']?>" >
    <input type="hidden" name="sid" value="<?php echo $row["sid"];?>"/>
        <tr>
<?php 
?>
          
          <td align="center"><?php $studid=$row["studid"]; echo $row["studid"]; ?></td>
          <td><?php $studname=$row["studname"]; echo $row["studname"]; ?></td>
          <td align="center"> <?php $class=$row["class"]; echo $row["class"]; ?></td>
